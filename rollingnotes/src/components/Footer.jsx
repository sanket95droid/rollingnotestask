...
const Footer = () => {
  return (
    <div className="flex flex-col bottom-0">
      <div className="bottom-0 flex flex-row bg-[#54595f] h-[548px] py-[60px] px-[84px] hover:cursor-pointer">
            ...
            <div className="w-[252px] h-[280px] mr-[20px] text-[15px] font-bold left-0 flex flex-col hover:cursor-pointer ">
